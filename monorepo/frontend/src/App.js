...
function App() {
  ...
  const { recommendations, getRecommendations } = useRecommendations(products);
  ...
  return (
    <div className="bg-[#07151E] p-6 text-white min-h-screen flex flex-col justify-center items-center ">
      <h1 className="text-3xl font-bold mb-8">
        Recomendador de Produtos RD Station
      </h1>
      <div className="bg-white text-black p-8 rounded-lg shadow-md w-full md:w-3/4 lg:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-8">
